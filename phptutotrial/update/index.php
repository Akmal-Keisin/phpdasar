...
<body>
    ...
    <br>
    <form action="" method="post" style="width: 500px; margin-bottom:20px;">
        <div class="input-group">
            ...
            <a href="tambah.php" class="btn btn-primary" style="margin-left: 20px;">tambah siswa</a>
        </div>     
    </form>
    <table border="1px solid black" cellpadding="10px" cellspacing="0" class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="hapus.php?id= <?= $row["id"]?>" onclick="return confirm('yakin hapus')">hapus</a></td>
                <td><?= $row["nama"] ?></td>
                <td><?= $row["nisn"] ?></td>
                <td><?= $row["email"] ?></td>
                <td><?= $row["jurusan"] ?></td>
